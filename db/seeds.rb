...
data = {
    ...
    "Fly Fishing": "... if you cant catch flies any OTHER way ...",
    ...
    "Graffiti": "Art in a can.  Were drawn to it.",
...
i = 0 
while i < adjectives.values.length 
	GreenCard.create(adjective: adjectives.keys[i], synonyms: adjectives.values[i]) 
	i+=1
end 
